...
if uploaded_file is not None:
    ...
    linguistic_keywords = {
        '18-24': linguistic_keywords_18_24,
        '25-34': linguistic_keywords_25_34,
        '35-44': linguistic_keywords_35_44,
        '45-54': linguistic_keywords_45_54,
        '55-64': linguistic_keywords_55_64,
        '65+': linguistic_keywords_65_plus
    }

    # Fungsi untuk menghitung skor linguistik
    def linguistic_score(text):
        text = str(text).lower()
        score = {}
        for age_group, keywords in linguistic_keywords.items():
            count = sum(1 for word in keywords if word in text)
            score[age_group] = count
        max_score_age = max(score, key=score.get)
        return max_score_age
